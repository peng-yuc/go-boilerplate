...
// TransferTx transfers money from one account to the other. It creates the
// transfer, adds two account entries, and updates accounts' balance within a
...
func (store *Store) TransferTx(ctx context.Context, arg TransferTxParams) (TransferTxResult, error) {
	...
	err := store.execTx(ctx, func(q *Queries) error {
		...
		// Update the account with smaller ID to prevent potential deadlock.
